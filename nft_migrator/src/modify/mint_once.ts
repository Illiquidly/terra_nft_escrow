...
async function main() {
  ...
  let minter =
    'terra1kfm48xrg00r3amen5v2uny4fayhr3m0d6p7f925y8d0t38562vhqkfn4rv';
  ...
  let mint_msg = {
    mint_request: {
      mint_msg: {
        token_id: '4032',
        owner: 'terra1zrl20sj9qx5xzlae5khp69larfejnt6t65mfag',
        token_uri: 'ipfs://QmeXDUz3LGDLMCSumuGxkh6ZjHfqafNmSt1jZXM49VNWsJ',
        extension: {
          image: 'ipfs://QmWfdTpBoF3cXYjGAsCd7EJfLsKREG3eVpFhERViDoUtyJ',
          image_data: null,
          external_url: null,
          description:
            'Galactic Punks are 10,921 randomly generated NFTs on the Terra blockchain.',
          name: 'Galactic Punk #4032',
          attributes: [
            {
              display_type: null,
              trait_type: 'backgrounds',
              value: 'green planet day'
            },
            {
              display_type: null,
              trait_type: 'suits',
            ...
            { display_type: null, trait_type: 'species', value: 'zombie 2' },
            {
              display_type: null,
              trait_type: 'jewelry',
    ...
    signature:
      'FtI3xJ6LrHTmJvnh1H0DrWVKI0nUOltMaW3LGT7Aort769br95K5KA6KB3Zz/Lp9PPEs6AC1qhmM8rkStDWIvg=='
  };
